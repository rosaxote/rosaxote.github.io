---
layout: post
title: Welcome to the Jungle? More like Temperate Forest
published: false
category: main
---
...
An ecosystem comes in all flavors and variations. On Earth, our natural ecosystems range from dense, humid tropical rainforest (with vast species diversity and biomass condensed into a relatively small footprint) to spare, punishing Arctic desert, where only a fraction of life can survive. Around the middle of these extremes is the temperate forest and grasslands, with relatively mild seasons, rich soil, and low-to-moderate species abundance. 

A temperate forest has the following characteristics:

- Natural pathogens and enemies are low
- There are frequent disturbances that upset an existing order
- Far less competition
- Rewards fast growth over specialized defenses

I’ll dive into why this is ideal for a startup business, but first let me explain why a jungle — aka a densely packed ecosystem — is one of the harshest places to start a business.

THE JUNGLE IS A TERRIBLE PLACE FOR A STARTUP

Despite its outward appearance of lush abundance, a jungle is a terrible place for a new seedling.
...
By contrast, a temperate forest is an ideal place for a seedling to start out. There is much less competition, and fewer natural predators. There are also routine disturbances (winter freezes, forest fires) that level the playing field, ensuring new players can get a foothold. 
