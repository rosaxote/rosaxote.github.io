---
layout: post
title: Businesses as Dissipative Structures
published: true
category: main
---
...
<p class="meta">6.5.26 - SF Bay area</p>

How did life arise? Many people have pondered this question since antiquity. In the 20th century, scientists noticed that highly intricate and specialized systems could arise out of nowhere, wherever there is an energy imbalance. Belgian chemist Ilya Prigogine called these "dissipative structures" (and later won the 1977 Nobel Prize for his work on them). 
...
Businesses exist as long as these gradients exist; the gradients fuel them. You only need to sufficiently (not perfectly) serve the gradient to keep in existence; anyone sees that sticking a branch in a stream does not stop the stream -- it will instantly adapt the water flow around it. You would need to completely dam a stream to stop the flow, and even then, the water will build up on the opposing side until it overflows. 
